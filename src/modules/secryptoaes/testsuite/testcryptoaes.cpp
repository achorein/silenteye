...
#include "testcryptoaes.h"

void TestCryptoAES::encryption_data()
{
    loadModule();
...
void TestCryptoAES::loadModule()
{
    ...
    foreach (QString fileName, pluginsDir.entryList(QDir::Files))
    {
        ...
        if( plugin )
        {
            ...
            if( moduleC && moduleC->typeSupported().contains("AES128"))
            {
                m_module = moduleC;
            }
        }
