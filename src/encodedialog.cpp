...
namespace SilentEye {
        ...
        : OptionDialog(parent)
    {
        ...
        exportLabel->setText("Export conf:");
    ...
    void EncodeDialog::ok()
    {
        ...
        if(!currentFormatModule()->encodeWidget()->isReady())
        {
        ...
        try
        {
            ...
            if (m_filePath != "" && QFile::exists(m_filePath))
            {
                ...
                data = new EncodedData(file, compressSpinBox->value());
            }
            else
            {
            ...
            if(cryptoCheckBox->checkState()!=Qt::Unchecked)
            {
                ...
                if(module!=NULL)
                {
                    ...
                    data->setCompressed(compressSpinBox->value(), true);
                }
                else
